...
Job.prototype.catchError = require('./catch-error');
Job.prototype.log = require('./log');
Job.prototype.resetTimeout = require('./reset-timeout');
Job.prototype._setTimeout = require('./set-timeout');
